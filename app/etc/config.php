...
return [
    'modules' => [
        ...
        'Magento_Inventory' => 0,
        'Dentalkart_PlugEmailme' => 0,
        'Dentalkart_PricealertGraphQl' => 1,
        'Dentalkart_SignupAlertGraphQl' => 0,
        'Dentalkart_Stockalert' => 0,
        'Dentalkart_StockalertGraphQl' => 0,
        'Dentalkart_Stockdemo' => 1,
        'Magento_Variable' => 1,
